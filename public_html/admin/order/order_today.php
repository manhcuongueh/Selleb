...
$sql_search = " where (left(gs_se_id,3)='AP-' or gs_se_id = 'admin')
                  and orderdate_s = '$time_ymd'
				  and dan != '0' ";
...
<div class="tbl_head01">
	...
	<tr>
		<td>
			<input type="checkbox" name="chk[]" <?php if(in_array($row[dan], array('5','6'))) { echo "disabled"; };?> value="<?php echo $i; ?>">
	...
	<?php
		if($max[max_idx] == $od_table) {
			...
			echo "<td class='tar fc_red bold'>".number_format($sum[use_amt])."</td>";
			echo "<td class='tar bold' colspan='3'>총계 : ".number_format($sum[amt]+$sum[del_amt])."</td>";
			echo "</tr>";
		}
	}
	if($i==0)
