...
$sql_search = " where (left(gs_se_id,3)='AP-' or gs_se_id = 'admin') and dan = '4' ";
...
<button type="button" onclick="btn_check('delete')" class="btn_small bx-white">선택삭제</button>
...
<div class="tbl_head01">
	...
	<tr>
		...
		<td rowspan="2"><?php echo $row[gs_se_id];?></td>
	</tr>
	<tr class="rows">
		<td colspan="3">
...
<div class="local_frm02">
	...
	<p id="opt_4">
		...
		<input type="text" name="gonumber" class="frm_input w170" onkeyup='chk_gonumber(this.value);'>
	</p>
