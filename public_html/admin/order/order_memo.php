...
$sql_search = " where (left(a.gs_se_id,3)='AP-' or a.gs_se_id = 'admin') ";
...
<div class="tbl_head01">
	...
	<tr>
		...
		<th><?php echo subject_sort_link('b.orderdate_s',$q2);?>주문일</a></th>
...
function btn_check(act)
{
	...
	if(act == "delete") // 선택삭제
    {
        f.action = './order/order_memo_delete.php';
        str = "삭제";
    }
    else
        return;
