...
<div class="tbl_frm02">
	...
	<tr>
		<th>엑셀배송처리</th>
		<td><a href="/admin/order/order_deliveryexcel.php" class="btn_small bx-blue"><i class="fa fa-download"></i> 배송대기 주문내역 다운로드</a></td>
	</tr>
	<tr>
		<th>파일 업로드</th>
...
function forderdelivery_submit(f)
{
	...
	f.action = "/admin/order.php?code=delivery_xls_update";
	return true;
}
</script>
