...
$sql_search = " where (left(gs_se_id,3)='AP-' or gs_se_id = 'admin') and dan = '1' ";
...
<div class="tbl_head01">
	...
	<tr class="rows">
		<td colspan="3">
			<?php echo get_sorts_conf_select("od_delivery[]","","disabled");?>
			<input type="text" name="od_gonumber[]" disabled class="frm_input w130">
		</td>
	</tr>
	<?php
...
function chk_dan(n) {
	...
	if(n == 4) {
		document.getElementById('opt_4').style.display = '';

		for(var i=0; i<chk.length; i++) {
			delivery[i].disabled = false;
			gonumber[i].disabled = false;
		}
	} else {
