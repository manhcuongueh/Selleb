...
<div class="price_engine">
	...
	<dd>
		<ul>
			...
			<li>&#8226; 전체상품 URL : <a href="<?php echo TW_SHOP_URL; ?>/price/naver.php" target="_blank"><?php echo TW_SHOP_URL; ?>/price/naver.php</a></li>
			<li>&#8226; 요약상품 URL : <a href="<?php echo TW_SHOP_URL; ?>/price/naver_summary.php" target="_blank"><?php echo TW_SHOP_URL; ?>/price/naver_summary.php</a></li>
		</ul>
	</dd>
	...
	<dd>
		<ul>
			...
			<li>&#8226; 전체상품 URL : <a href="<?php echo TW_SHOP_URL; ?>/price/daum.php" target="_blank"><?php echo TW_SHOP_URL; ?>/price/daum.php</a></li>
			<li>&#8226; 요약상품 URL : <a href="<?php echo TW_SHOP_URL; ?>/price/daum_summary.php" target="_blank"><?php echo TW_SHOP_URL; ?>/price/daum_summary.php</a></li>
		</ul>
	</dd>
</div>