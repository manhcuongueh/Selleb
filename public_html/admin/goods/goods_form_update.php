...
$value['money_type'] = $_POST['money_type']; //수수료적용타입
$value['money_yo'] = $_POST['money_yo'];
$value['money_acc'] = reb_arr($_POST['money_acc']);
$value['money_dan'] = $_POST['money_dan'];
...
if($w == "")
    goto_url("../goods.php?code=form&w=u&gs_id=$gs_id");
else if($w == "u")
    goto_url("../goods.php?code=form&w=u&gs_id=$gs_id$q1&page=$page&bak=$bak");
?>