...
<button type="button" onclick="btn_check('rank');" class="btn_lsmall bx-white">선택순위수정</button>
<button type="button" onclick="btn_check('copy');" class="btn_lsmall bx-white">선택상품복사</button>
<a href="./goods/goods_list_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀다운로드</a>
