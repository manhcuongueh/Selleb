...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><?php echo $num--; ?></td>
		<td><input type="text" class="frm_input" name="br_name[<?php echo $i; ?>]" value="<?php echo$row['br_name']; ?>"></td>
		<td><input type="text" class="frm_input" name="br_name_eng[<?php echo $i; ?>]" value="<?php echo$row['br_name_eng']; ?>"></td>
...
function fregform_submit(f){
	...
	f.action = "./goods/goods_brand_update.php";
    return true;
}
...
function btn_check(act)
{
    ...
    if(act == "update") // 선택수정
    {
        f.action = './goods/goods_brand_list_update.php';
        str = "수정";
    }
    else if(act == "delete") // 선택삭제
    {
        f.action = './goods/goods_brand_list_delete.php';
        str = "삭제";
    }
    else
        return;
