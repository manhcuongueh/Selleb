...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><?php echo get_text($row[gs_se_id]); ?></td>
		<td><?php echo date("Y/m/d",$row[wdate]); ?></td>
		<td>
			<img src="/img/sub/score_<?php echo $row[score]; ?>.gif">
			<p class="mart3">(<?php echo get_text($row[writer_s]); ?>)</p>
		</td>
	</tr>
	<?php 
	}
...
function btn_check(act)
{
    ...
    if(act == "delete") // 선택삭제
    {
        f.action = './goods/goods_review_delete.php';
        str = "삭제";
    }
    else
        return;
