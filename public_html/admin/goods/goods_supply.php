...
<button type="button" onclick="btn_check('state');" class="btn_lsmall bx-red">선택승인</button>
<button type="button" onclick="btn_check('defer');" class="btn_lsmall bx-blue">선택보류</button>
<a href="./goods/goods_supply_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀다운로드</a>
...
<div class="tbl_head02">
	...
	<tr>
		...
		<th colspan="3" class="th_bg">가격정보</th>
		<th rowspan="2"><?php echo subject_sort_link('a.shop_state',$q2); ?>상태</a></th>
		<th rowspan="2">관리</th>
	</tr>
	<tr class="rows">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="2"><?php echo $ar_state[$row['shop_state']]; ?></td>
...
function btn_check(act)
{
	...
	else if(act == "state") // 선택승인
    {
        f.action = './goods/goods_supply_update.php?w=state';
        str = "승인";
    }
	else if(act == "defer") // 선택보류
    {
        f.action = './goods/goods_supply_update.php?w=defer';
        str = "보류";
    }
    else
        return;
