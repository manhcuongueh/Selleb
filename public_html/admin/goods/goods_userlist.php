...
<a href="./goods/goods_userlist_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀다운로드</a>
...
<div class="tbl_head02">
	...
	<tr class="rows">
		<th><?php echo subject_sort_link('a.mb_id',$q2); ?>가맹점ID</a></th>
		<th>가맹점명</th>
		<th>카테고리</th>
