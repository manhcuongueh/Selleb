...
$frm_submit = '<div class="btn_confirm">
	...
	<a href="design.php?code=banner&page='.$page.'" class="btn_large bx-white marl3">목록</a>'.PHP_EOL;
if($w == 'u')
	$frm_submit .= '<a href="design.php?code=banner_form" class="btn_large bx-red marl3">추가</a>'.PHP_EOL;
$frm_submit .= '</div>';
...
function fbannerform_submit(f) {
	f.action = "./design/web_banner_form_update.php";
    return true;
}
