...
<a href="design.php?code=slider_form" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 추가하기</a>
EOF;
?>
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$s_upd = "<a href='design.php?code=slider_form&w=u&ba_table=$ba_table&page=$page' class=\"btn_small\">수정</a>";
...
function btn_check(act)
{
    ...
    if(act == "update") // 선택수정
    {
        f.action = './design/web_slider_list_update.php';
        str = "수정";
    }
    else if(act == "delete") // 선택삭제
    {
        f.action = './design/web_slider_list_delete.php';
        str = "삭제";
    }
    else
        return;
