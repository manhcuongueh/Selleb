...
<div class="tbl_frm02">
	...
	<tr>
		<th>샘플파일 다운</th>
		<td><a href="<?php echo TW_INC_URL; ?>/Excel/memberexcel.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 샘플파일 다운로드</a></td>
	</tr>
	<tr>
		<th>파일 업로드</th>
...
<div class="btn_confirm">
	<input type="submit" value="회원 일괄등록" class="btn_large">
</div>
</form>
...
function fmemberexcel_submit(f)
{
	...
	f.action = "/admin/member.php?code=xls_update";
	return true;
}
</script>