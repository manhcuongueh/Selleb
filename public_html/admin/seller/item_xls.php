...
<div class="tbl_frm02">
	...
	<tr>
		<th>샘플파일 다운</th>
		<td><a href="<?php echo TW_INC_URL; ?>/Excel/sellerexcel.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 샘플파일 다운로드</a></td>
	</tr>
	<tr>
		<th>파일 업로드</th>
...
function fsellerexcel_submit(f)
{
	...
	f.action = "/admin/seller.php?code=xls_update";
	return true;
}
</script>