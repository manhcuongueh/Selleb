...
<h1 class="psms_tit"><?php echo $gw_head_title; ?></h1>
<div class="psms_wrap">
...
<input type='hidden' name='ph' value='<?php echo $ph;?>'>
	...
	<tr>
		<th>수신번호</th>
		<td><input name="recv_number" type="text" class="frm_input wfull" value="<?php echo $ph?>" maxlength="20"></td>
	</tr>
	</tbody>
	</table>
	</div>
