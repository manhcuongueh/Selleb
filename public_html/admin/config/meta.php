...
<div class="tbl_frm01">
	...
	<tr>
		<th>브라우저 타이틀</th>
		<td>
			<input type="text" name="head_title" value="<?php echo $config['head_title']; ?>" class="frm_input w470">
	...
	<tr>
		<th>Author : 메타태그 1</th>
		<td>
			<input type="text" name="meta_author" value="<?php echo $config['meta_author']; ?>" class="frm_input w470">
	...
	<tr>
		...
		<td>
			<input type="text" name="meta_description" value="<?php echo $config['meta_description']; ?>" class="frm_input w470">
...
function fregform_submit(f) {
	f.action = "./config/meta_update.php";
    return true;
}
</script>
