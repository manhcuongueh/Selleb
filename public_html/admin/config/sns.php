...
<div class="tbl_frm01">
	...
	<tr>
		<th>네이버 Client ID</th>
		<td>
			<input type="text" name="de_naver_appid" value="<?php echo $default['de_naver_appid']; ?>" class="frm_input w325">
	...
	<tr>
		...
		<td><input type="text" name="de_naver_secret" value="<?php echo $default['de_naver_secret']; ?>" class="frm_input w325"></td>
	</tr>
	<tr>
		<th>페이스북 앱 ID</th>
		<td>
			<input type="text" name="de_facebook_appid" value="<?php echo $default['de_facebook_appid']; ?>" class="frm_input w325">
			<a href="https://developers.facebook.com" target="_blank" class="btn_small grey">앱 등록하기</a>
		</td>
	</tr>
	<tr>
		<th>페이스북 앱 Secret</th>
		<td><input type="text" name="de_facebook_secret" value="<?php echo $default['de_facebook_secret']; ?>" class="frm_input w325"></td>
	</tr>
	<tr>
		<th>카카오 REST API Key</th>
		<td>
			<input type="text" name="de_kakao_rest_apikey" value="<?php echo $default['de_kakao_rest_apikey']; ?>" class="frm_input w325">
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<input type="text" name="de_googl_shorturl_apikey" value="<?php echo $default['de_googl_shorturl_apikey']; ?>" class="frm_input w325">
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			...
			<input type="text" name="de_insta_url" value="<?php echo $default['de_insta_url']; ?>" class="frm_input w150">			
		</td>
	</tr>
	<tr>
		<th>CLIENT ID</th>
		<td>
			<input type="text" name="de_insta_client_id" value="<?php echo $default['de_insta_client_id']; ?>" class="frm_input w325">
	...
	<tr>
		...
		<td><input type="text" name="de_insta_redirect_uri" value="<?php echo $default['de_insta_redirect_uri']; ?>" class="frm_input w325"></td>
	</tr>
	<tr>
		<th>ACCESS_TOKEN</th>
		<td>
			<input type="text" name="de_insta_access_token" value="<?php echo $default['de_insta_access_token']; ?>" class="frm_input w325">
...
function fregform_submit(f) {
	f.action = "./config/sns_update.php";
    return true;
}
