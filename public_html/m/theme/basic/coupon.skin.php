...
<div class="stit_txt tal">※ <?php echo $member['name']; ?>님의 쿠폰내역</div>
<div class="m_mypage_bg">
	...
	<tbody>
	<tr>
		<td<?php echo $selected1; ?>><a href="./coupon.php">사용가능쿠폰</a></td>
		<td<?php echo $selected2; ?>><a href="./coupon.php?sca=1">사용/기한만료쿠폰</a></td>
	</tr>
	</tbody>
	</table>
	...
	<div class="my_list">
		...
		?>
		<tr class="tit">
			<td class="mi_dt tal strong"><?php echo $row['cp_wdate']; ?></td>
