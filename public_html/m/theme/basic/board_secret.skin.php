...
<form name="frm" action="./board_read.php" method="get" onsubmit="return frm_submit(this);">
...
<div class="m_bo_pop">
	...
	<div class="formbox" style="margin:10px 0 0 0;">
		<input type="password" name="inpasswd" placeholder='비밀번호' onFocus="this.placeholder=''">
	</div>
