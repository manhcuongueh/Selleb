...
// 인증 링크 생성
$href = TW_BBS_URL.'/password_lost_certify.php?mb_no='.$mb['index_no'].'&mb_nonce='.$mb_nonce;
...
$content .= '<a href="'.TW_URL.'" target="_blank">'.$config['company_name'].'</a>';
$content .= '</span>';
$content .= '<p style="margin:20px 0 0;padding:30px 30px 30px;border-bottom:1px solid #eee;line-height:1.7em">';
$content .= addslashes($mb['name'])." 회원님은 ".$time_ymdhis." 에 회원정보 찾기 요청을 하셨습니다.<br>";
