...
$sModulePath	= $_SERVER['DOCUMENT_ROOT']."/m/".$tb['bbs']."/chekplus/IPIN2Client"; // NICE로부터 받은 암호화 프로그램의 위치
$sReturnURL		= "http://".$_SERVER['HTTP_HOST']."/m/".$tb['bbs']."/chekplus/ipin_process.php"; // 하단내용 참조
$sCPRequest		= ""; // 하단내용 참조
...
$key = $_SESSION['CPREQUEST'];
$sql1="insert into shop_joincheck set j_key = '$key'";
sql_query($sql1);
...
┌ sReturnURL 변수에 대한 설명  ─────────────────────────────────────────────────────
	...
	* 당사에서 배포해드린 샘플페이지 중, ipin_process.jsp 페이지가 사용자 정보를 리턴받는 예제 페이지입니다.
	...
	예 - http://www.test.co.kr/ipin_process.php, https://www.test.co.kr/ipin_process.php, https://test.co.kr/ipin_process.php
└────────────────────────────────────────────────────────────────────
