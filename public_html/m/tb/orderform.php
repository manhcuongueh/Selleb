...
$prc_attr = "readonly style='background-color:#f1f1f1;font-weight:bold;color:red;width:99px;'";
$not_attr = "readonly style='background-color:#fafafa;'";

$sql = " select * from shop_cart where index_no IN ({$ss_cart_id}) group by gs_id order by index_no ";
$result = sql_query($sql);

$order_action_url = './orderform_update.php';
