...
if($is_seometa == 'it') { // 상품
	...
	$seometa['url'] = TW_SHOP_URL.'/view.php?index_no='.$gs['index_no'];
...
$seometa['title'] = ($seometa['title']) ? $seometa['title'] : $gw_head_title;
...
$seometa['url'] = ($seometa['url']) ? $seometa['url'] : TW_URL;
...
if($seometa['img'] && preg_match("/(\.(jpg|jpeg|gif|png))$/i", $seometa['img'])) {
	$seometa['img'] = $seometa['img'].'?v='.$time_Yhs;
}
?>
