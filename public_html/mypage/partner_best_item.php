...
<div class="tbl_head01">
	...
	<tr>
		...
		<td><input type="text" name="de_maintype_title" value="<?php echo $partner['de_maintype_title']; ?>" class="frm_input wfull" placeholder="최상위 타이틀명" required itemname="최상위 타이틀명"></td>
		<td></td>
	</tr>
	<?php
	$list = unserialize(base64_decode($partner['de_maintype_best']));
	for($i=0; $i<10; $i++) {
	?>
	<tr>
...
function fregform_submit(f) {
	f.action = "./partner_best_item_update.php";
    return true;
}
</script>
