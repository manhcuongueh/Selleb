...
$frm_submit = '<div class="btn_confirm">
	...
	<a href="page.php?code=partner_slider_list&page='.$page.'" class="btn_large bx-white marl3">목록</a>'.PHP_EOL;
if($w == 'u')
	$frm_submit .= '<a href="page.php?code=partner_slider_form" class="btn_large bx-red marl3">추가</a>'.PHP_EOL;
$frm_submit .= '</div>';
?>
...
function fbannerform_submit(f) {
	f.action = "./partner_slider_form_update.php";
    return true;
}
</script>
