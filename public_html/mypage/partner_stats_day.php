...
<div class="tbl_head01">
	...
	for($i=1; $i<=31; $i++) {
		...
		$row1 = sql_fetch("select count(*) as cnt $sql_common $sql_where and left(reg_time,10)='$search_d' ");
		$row2 = sql_fetch("select count(*) as cnt $sql_common $sql_where and left(reg_time,10)='$search_d' and grade between '7' and '9' ");
		$row3 = sql_fetch("select count(*) as cnt $sql_common $sql_where and left(reg_time,10)='$search_d' and grade between '2' and '6' ");
