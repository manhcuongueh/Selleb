...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>   
			<input type="text" name="de_naverpay_mid" value="<?php echo $partner['de_naverpay_mid']; ?>" id="de_naverpay_mid" class="frm_input" size="20" maxlength="50">
	...
	<tr>
		...
		<td>
			<input type="text" name="de_naverpay_cert_key" value="<?php echo $partner['de_naverpay_cert_key']; ?>" id="de_naverpay_cert_key" class="frm_input" size="50" maxlength="100">
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_naverpay_button_key" value="<?php echo $partner['de_naverpay_button_key']; ?>" id="de_naverpay_button_key" class="frm_input" size="50" maxlength="100">
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_naverpay_mb_id" value="<?php echo $partner['de_naverpay_mb_id']; ?>" id="de_naverpay_mb_id" class="frm_input" size="20" maxlength="20">
	...
	<tr>
		...
		<td>                
			<?php echo TW_SHOP_URL; ?>/naverpay/naverpay_item.php
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_naverpay_sendcost" value="<?php echo $partner['de_naverpay_sendcost']; ?>" id="de_naverpay_sendcost" class="frm_input" size="60">
...
function fregform_submit(f) {
	f.action = "./partner_naverpay_update.php";
    return true;
}
</script>
