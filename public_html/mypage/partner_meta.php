...
<div class="tbl_frm01">
	...
	<tr>
		<th>브라우저 타이틀</th>
		<td>
			<input type="text" name="head_title" value="<?php echo $partner['head_title']; ?>" class="frm_input w470">
	...
	<tr>
		<th>Author : 메타태그 1</th>
		<td>
			<input type="text" name="meta_author" value="<?php echo $partner['meta_author']; ?>" class="frm_input w470">
			<?php echo help('페이지 또는 사이트의 제작자명을 명시할 수 있습니다. 간략하게 입력하세요.'); ?>
		</td>
	</tr>
	<tr>
		<th>description : 메타태그 2</th>
		<td>
			<input type="text" name="meta_description" value="<?php echo $partner['meta_description']; ?>" class="frm_input w470">
			<?php echo help('검색엔진의 검색결과에서 페이지의 요약내용을 보여주는 부분으로 1-2개의 문장이나 짧은 단락을 사용하는 것이 좋습니다.'); ?>
		</td>
	</tr>
	<tr>
		<th>keywords : 메타태그 3</th>
		<td>
			<textarea name="meta_keywords" class="frm_textbox wfull" rows="5"><?php echo $partner['meta_keywords']; ?></textarea>
	...
	<tr>
		<th>추가 메타태그</th>
		<td>
			<textarea name="add_meta" class="frm_textbox wfull" rows="5"><?php echo $partner['add_meta']; ?></textarea>
...
<div class="tbl_frm01">
	...
	<tr>
		<th>&lt;HEAD&gt; 내부 태그</th>
		<td>
			<textarea name="head_script" class="frm_textbox wfull" rows="5"><?php echo $partner['head_script']; ?></textarea>
	...
	<tr>
		<th>&lt;BODY&gt; 내부 태그</th>
		<td>
			<textarea name="tail_script" class="frm_textbox wfull" rows="5"><?php echo $partner['tail_script']; ?></textarea>
...
function fregform_submit(f) {
	f.action = "./partner_meta_update.php";
    return true;
}
</script>
