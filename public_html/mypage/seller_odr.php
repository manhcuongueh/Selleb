...
<a href="./seller_odr_excel.php?$q1" class="btn_small bx-white"><i class="fa fa-file-excel-o"></i> 엑셀다운로드</a>
EOF;
?>
...
function btn_check(act)
{
    ...
    if(act == "update") // 선택변경
    {
        f.action = './seller_odr_update.php';
        str = "변경";
    }
	else if(act == "dydate") // 선택수정
    {
        f.action = './seller_odr_update_dy.php';
        str = "수정";
    }
    else if(act == "delete") // 선택삭제
    {
        f.action = './seller_odr_delete.php';
        str = "삭제";
    }
    else
        return;
