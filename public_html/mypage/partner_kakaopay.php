...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>                
		   <input type="text" name="de_kakaopay_mid" value="<?php echo $partner['de_kakaopay_mid']; ?>" id="de_kakaopay_mid" class="frm_input" size="20">
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_kakaopay_key" value="<?php echo $partner['de_kakaopay_key']; ?>" id="de_kakaopay_key" class="frm_input" size="50">
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_kakaopay_enckey" value="<?php echo $partner['de_kakaopay_enckey']; ?>" id="de_kakaopay_enckey" class="frm_input" size="20">
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_kakaopay_hashkey" value="<?php echo $partner['de_kakaopay_hashkey']; ?>" id="de_kakaopay_hashkey" class="frm_input" size="20">
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_kakaopay_cancelpwd" value="<?php echo $partner['de_kakaopay_cancelpwd']; ?>" id="de_kakaopay_cancelpwd" class="frm_input" size="20">
...
function fregform_submit(f) {
	f.action = "./partner_kakaopay_update.php";
    return true;
}
</script>
