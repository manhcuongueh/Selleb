...
<a href="./partner_goods_list_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀다운로드</a>
<a href="page.php?code=partner_goods_form" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 상품등록</a>
EOF;
?>
...
<div class="tbl_head02">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="2"><a href="page.php?code=partner_goods_form&w=u&gs_id=<?php echo $gs_id.$qstr; ?>&page=<?php echo $page; ?>&bak=<?php echo $code; ?>" class="btn_small">수정</a></td>
	</tr>
	<tr class="<?php echo $bg; ?>">
...
function btn_check(act)
{
    ...
    if(act == "delete") // 선택삭제
    {
        f.action = './partner_goods_list_delete.php';
        str = "삭제";
    }
	else if(act == "copy") // 선택복사
    {
        f.action = './partner_goods_list_copyupdate.php';
        str = "복사";
    }
	else if(act == "move") // 선택이동
    {
        f.action = './partner_goods_list_moveupdate.php';
        str = "이동";
    }
    else
        return;
