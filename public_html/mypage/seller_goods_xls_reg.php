...
<div class="tbl_frm02">
	...
	<tr>
		<th>샘플파일 다운</th>
		<td>
			<a href="<?php echo TW_INC_URL; ?>/Excel/itemexcel2.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 샘플파일 다운로드</a>
			<a href="<?php echo TW_ADMIN_URL; ?>/category/sho_cate_excel.php" class="btn_small bx-blue"><i class="fa fa-download"></i> 본사 카테고리 다운로드</a>
		</td>
	</tr>
	<tr>
		<th>파일 업로드</th>
...
<div class="btn_confirm">
	<input type="submit" value="상품 일괄등록" class="btn_large">
</div>
</form>
...
function fitemexcel_submit(f)
{
	...
	f.action = "./page.php?code=seller_goods_xls_reg_update";
	return true;
}
</script>
