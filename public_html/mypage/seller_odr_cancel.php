...
<a href="./seller_odr_cancel_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀다운로드</a>
EOF;
?>
...
function btn_check(act)
{
    ...
    if(act == "update") // 선택수정
    {
		f.action = './seller_odr_cancel_update.php';
        str = "수정";
    }
	else if(act == "ca_yn") // 선택승인
    {
        f.action = './seller_odr_cancel_yn.php';
        str = "취소";
    }
	else if(act == "delete") // 선택삭제
    {
        f.action = './seller_odr_cancel_delete.php';
        str = "삭제";
    }
    else
        return;
