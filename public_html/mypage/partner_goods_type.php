...
$sql_search = " where (a.use_aff='0' or (a.use_aff='1' and a.mb_id='$mb_id')) and a.shop_state='0' ";
...
<form name="fgoodslist" method="post" action="./partner_goods_type_update.php">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {		
		...
		$sql2 = " select * from shop_goods_type where mb_id = '$mb_id' and gs_id = '$gs_id' ";
		$row2 = sql_fetch($sql2);
