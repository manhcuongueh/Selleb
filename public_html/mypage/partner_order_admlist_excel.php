...
// Put Excel data
$data = array('가맹점','판매수수료','주문번호','일련번호','상품명','옵션','주문수량','쿠폰할인','적립금결제','배송비','실결제금액','총계','결제방법','현황','주문자명','수취인명','수취인연락처','수취인핸드폰','수취인우편번호','수취인주소','주문시전달사항','배송업체','송장번호','입금자명','입금날짜','주문날짜','사업자등록번호','사업자상호명','대표명','사업장소재지','업태','종목','매입계산서 요청','현금영수증 사업자지출용','현금영수증 개인소득용');
...
while($row = sql_fetch_array($result)) {
	...
	$worksheet->write($i, $j++, $row1[in_money]);
