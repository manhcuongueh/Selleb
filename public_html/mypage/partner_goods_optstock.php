...
$sql_search = " where c.mb_id = '$member[id]' ";
...
$sql = " select a.*, c.simg1, c.gcode, c.gname, c.mb_id
...
<div class="tbl_head02">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="2"><a href="page.php?code=partner_goods_form&w=u&gs_id=<?php echo $row['gs_id'].$qstr; ?>&page=<?php echo $page; ?>&bak=<?php echo $code; ?>" class="btn_small">수정</a></td>
	</tr>
	<tr class="<?php echo $bg; ?>">
...
function btn_check(act)
{
    ...
    if(act == "w1") // 선택변경
    {
        f.action = './partner_goods_optstock_update.php';
        str = "적용";
    }
    else
        return;
