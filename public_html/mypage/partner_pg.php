...
<div class="tbl_frm01">
	...
	<tr>
		<th>결제수단</th>
		<td class="td_label">
			<input id='cf_bank_yn' type="checkbox" name="cf_bank_yn" value="1" <?php echo get_checked($partner['cf_bank_yn'], "1"); ?>>
			<label for="cf_bank_yn">무통장결제</label>
			<input id='cf_card_yn' type="checkbox" name="cf_card_yn" value="1" <?php echo get_checked($partner['cf_card_yn'], "1"); ?>>
			<label for="cf_card_yn">신용카드</label>
			<input id='cf_iche_yn' type="checkbox" name="cf_iche_yn" value="1" <?php echo get_checked($partner['cf_iche_yn'], "1"); ?>>
			<label for="cf_iche_yn">실시간계좌이체</label>
			<input id='cf_vbank_yn' type="checkbox" name="cf_vbank_yn" value="1" <?php echo get_checked($partner['cf_vbank_yn'], "1"); ?>>
			<label for="cf_vbank_yn">가상계좌</label>
			<input id='cf_hp_yn' type="checkbox" name="cf_hp_yn" value="1" <?php echo get_checked($partner['cf_hp_yn'], "1"); ?>>
	...
	<tr>
		<th>결제시스템 방식</th>
		<td class="td_label">
			<input id="cf_card_test_yn2" type="radio" name="cf_card_test_yn" value="0" <?php echo get_checked($partner['cf_card_test_yn'], "0"); ?>> <label for="cf_card_test_yn2">실결제</label>
			<input id="cf_card_test_yn1" type="radio" name="cf_card_test_yn" value="1" <?php echo get_checked($partner['cf_card_test_yn'], "1"); ?>> <label for="cf_card_test_yn1">테스트결제</label>
		</td>
	</tr>
	<tr>
		<th>복합과세 결제</th>
		<td class="td_label">
			<input id="cf_tax_flag_use_1" type="radio" name="cf_tax_flag_use" value="1" <?php echo get_checked($partner['cf_tax_flag_use'], "1"); ?>> <label for="cf_tax_flag_use_1">사용함</label>
			<input id="cf_tax_flag_use_2" type="radio" name="cf_tax_flag_use" value="0" <?php echo get_checked($partner['cf_tax_flag_use'], "0"); ?>> <label for="cf_tax_flag_use_2">사용안함</label>
		</td>
	</tr>
	<tr>
		<th>결제대행사</th>
		<td>
			<select name="cf_card_pg" onchange="chk_pay_method(this.value);" class="vam">
				<option value="ini"<?php echo get_selected($partner['cf_card_pg'], "ini"); ?>>KG이니시스</option>
				<option value="kcp"<?php echo get_selected($partner['cf_card_pg'], "kcp"); ?>>KCP</option>
				<option value="all"<?php echo get_selected($partner['cf_card_pg'], "all"); ?>>올더게이트</option>
			</select>
	...
	<tr>
		<th>상점명</th>
		<td><input type="text" name="cf_nm_pg" value="<?php echo $partner['cf_nm_pg']; ?>" class="frm_input w325">
...
<div class="tbl_frm01">
	...
	<tr>
		<th>KCP PG ID</th>
		<td><input type="text" name="cf_kcp_id" value="<?php echo $partner['cf_kcp_id']; ?>"
		class="frm_input w200"> <span class="fc_197 marl5">발급받으신 KCP PG ID를 입력하세요</span></td>
	</tr>
	<tr>
		<th>KCP KEY</th>
		<td><input type="text" name="cf_kcp_key" value="<?php echo $partner['cf_kcp_key']; ?>" class="frm_input w325"> <span class="fc_197 marl5">발급받으신 KCP KEY를 입력하세요</span></td>
	</tr>
	<tr>
		<th>현금영수증 발급</th>
		<td class="td_label">
			<input id="cf_kcp_tax_use1" type="radio" name="cf_kcp_tax_yn" value="Y" <?php echo get_checked($partner['cf_kcp_tax_yn'], "Y"); ?>>
			<label for="cf_kcp_tax_use1">사용함</label>
			<input id="cf_kcp_tax_use2" type="radio" name="cf_kcp_tax_yn" value="N" <?php echo get_checked($partner['cf_kcp_tax_yn'], "N"); ?>>
	...
	<tr>
		<th>최대 할부 개월</th>
		<td>
			<input type="text" name="cf_kcp_quota" value="<?php echo $partner['cf_kcp_quota']; ?>" class="frm_input w325">
	...
	<tr>
		<th>무이자 사용 여부</th>
		<td class="td_label">
			<input id="cf_kcp_noint_yn1" type="radio" name="cf_kcp_noint_yn" value="N" <?php echo get_checked($partner['cf_kcp_noint_yn'], "N"); ?>>
			<label for="cf_kcp_noint_yn1">일반할부</label>
			<input id="cf_kcp_noint_yn2" type="radio" name="cf_kcp_noint_yn" value="Y" <?php echo get_checked($partner['cf_kcp_noint_yn'], "Y"); ?>>
			<label for="cf_kcp_noint_yn2">일반 설정할부 (아래 할부기간 입력)</label>
			<input id="cf_kcp_noint_yn3" type="radio" name="cf_kcp_noint_yn" value="" <?php echo get_checked($partner['cf_kcp_noint_yn'], ""); ?>>
	...
	<tr>
		<th>무이자 할부 기간</th>
		<td>
			<input type="text" name="cf_kcp_noint_mt" value="<?php echo $partner['cf_kcp_noint_mt']; ?>" class="frm_input w325">
...
<div class="tbl_frm01">
	...
	<tr>
		<th>PG ID</th>
		<td><input type="text" name="cf_inicis_id" value="<?php echo $partner['cf_inicis_id']; ?>" class="frm_input w200"> <span class="fc_197 marl5">발급받으신 PG ID를 입력하세요</span></td>
	</tr>
	<tr>
		<th>일반 할부기간</th>
		<td>
			<input type="text" name="cf_inicis_quota" value="<?php echo $partner['cf_inicis_quota']; ?>" class="frm_input wfull">
	...
	<tr>
		<th>현금영수증 발급</th>
		<td class="td_label">
			<input id="cf_inicis_tax_use1" type="radio" name="cf_inicis_tax_yn" value="receipt" <?php echo get_checked($partner['cf_inicis_tax_yn'], "receipt"); ?>>
			<label for="cf_inicis_tax_use1">사용함</label>
			<input id="cf_inicis_tax_use2" type="radio" name="cf_inicis_tax_yn" value="no_receipt" <?php echo get_checked($partner['cf_inicis_tax_yn'], "no_receipt"); ?>>
	...
	<tr>
		<th>무이자 사용 여부</th>
		<td class="td_label">
			<input id="cf_inicis_noint_yn1" type="radio" name="cf_inicis_noint_yn" value="no" <?php echo get_checked($partner['cf_inicis_noint_yn'], "no"); ?>>
			<label for="cf_inicis_noint_yn1">일반결제</label>
			<input id="cf_inicis_noint_yn2" type="radio" name="cf_inicis_noint_yn" value="yes" <?php echo get_checked($partner['cf_inicis_noint_yn'], "yes"); ?>>
	...
	<tr>
		<th>무이자 할부 기간</th>
		<td>
			<input type="text" name="cf_inicis_noint_mt" value="<?php echo $partner['cf_inicis_noint_mt']; ?>" class="frm_input w325">
			<span class="fc_197">(아래 카드 코드표를 참조하세요!)</span>
	...
	<tr>
		...
		<td>
			<select name="cf_inicis_hp_unit">
				<option value="1" <?php echo get_selected($partner['cf_inicis_hp_unit'], "1"); ?>>1 - 컨텐츠</option>
				<option value="2" <?php echo get_selected($partner['cf_inicis_hp_unit'], "2"); ?>>2 - 실물(상품)</option>
			</select>
	...
	<tr>
		<th>결제창 스킨</th>
		<td class="td_label">
			<input id="cf_inicis_skin1" type="radio" name="cf_inicis_skin" value="ORIGINAL" <?php echo get_checked($partner['cf_inicis_skin'], "ORIGINAL"); ?>>
			<label for="cf_inicis_skin1">기본</label>
			<input id="cf_inicis_skin2" type="radio" name="cf_inicis_skin" value="GREEN" <?php echo get_checked($partner['cf_inicis_skin'], "GREEN"); ?>>
			<label for="cf_inicis_skin2">녹색</label>
			<input id="cf_inicis_skin3" type="radio" name="cf_inicis_skin" value="PURPLE" <?php echo get_checked($partner['cf_inicis_skin'], "PURPLE"); ?>>
			<label for="cf_inicis_skin3">보라색</label>
			<input id="cf_inicis_skin4" type="radio" name="cf_inicis_skin" value="RED" <?php echo get_checked($partner['cf_inicis_skin'], "RED"); ?>>
			<label for="cf_inicis_skin4">빨강</label>
			<input id="cf_inicis_skin5" type="radio" name="cf_inicis_skin" value="YELLOW" <?php echo get_checked($partner['cf_inicis_skin'], "YELLOW"); ?>>
...
<div class="tbl_frm01">
	...
	<tr>
		<th>올더게이트 PG ID</th>
		<td><input type="text" name="cf_ags_id" value="<?php echo $partner['cf_ags_id']; ?>" class="frm_input w200">
		<span class="fc_197 marl5">발급받으신 올더게이트 PG ID를 입력하세요</td>
	</tr>
	<tr>
		<th>일반 할부기간</th>
		<td>
			<input type="text" name="cf_ags_quota" value="<?php echo $partner['cf_ags_quota']; ?>" class="frm_input w325">
	...
	<tr>
		<th>무이자 사용 여부</th>
		<td class="td_label">
			<input id="cf_ags_noint_yn1" type="radio" name="cf_ags_noint_yn" value="0" <?php echo get_checked($partner['cf_ags_noint_yn'], "0"); ?>>
			<label for="cf_ags_noint_yn1">일반결제</label>
			<input id="cf_ags_noint_yn2" type="radio" name="cf_ags_noint_yn" value="1" <?php echo get_checked($partner['cf_ags_noint_yn'], "1"); ?>>
	...
	<tr>
		<th>무이자 할부 기간</th>
		<td>
			<input type="text" name="cf_ags_noint_mt" value="<?php echo $partner['cf_ags_noint_mt']; ?>" class="frm_input w325">
	...
	<tr>
		<th>CP아이디 (휴대폰)</th>
		<td><input type="text" name="cf_ags_hp_id" value="<?php echo $partner['cf_ags_hp_id']; ?>" class="frm_input w200">
		<span class="fc_197 marl5">발급받으신 CP아이디를 입력하세요</span></td>
	</tr>
	<tr>
		<th>CP비밀번호 (휴대폰)</th>
		<td><input type="text" name="cf_ags_hp_pwd" value="<?php echo $partner['cf_ags_hp_pwd']; ?>" class="frm_input w200">
		<span class="fc_197 marl5">발급받으신 CP비밀번호를 입력하세요</span></td>
	</tr>
	<tr>
		<th>SUB-CP아이디 (휴대폰)</th>
		<td><input type="text" name="cf_ags_hp_subid" value="<?php echo $partner['cf_ags_hp_subid']; ?>" class="frm_input w200">
		<span class="fc_197 marl5">발급받으신 SUB-CP아이디를 입력하세요</span></td>
	</tr>
	<tr>
		<th>상품코드 (휴대폰)</th>
		<td><input type="text" name="cf_ags_hp_code" value="<?php echo $partner['cf_ags_hp_code']; ?>" class="frm_input w200">
	...
	<tr>
		...
		<td>
			<select name="cf_ags_hp_unit">
				<option value="1" <?php echo get_selected($partner['cf_ags_hp_unit'], "1"); ?>>1 - 컨텐츠</option>
				<option value="2" <?php echo get_selected($partner['cf_ags_hp_unit'], "2"); ?>>2 - 실물(상품)</option>
			</select>
...
<div class="tbl_frm01">
	...
	<tr>
		<th>사용여부</th>
		<td class="td_label">
			<input id="cf_inicis_escrow_yn1" type="radio" name="cf_escrow_yn" value="1" <?php echo get_checked($partner['cf_escrow_yn'], "1"); ?>>
			<label for="cf_inicis_escrow_yn1">사용함</label>
			<input id="cf_inicis_escrow_yn2" type="radio" name="cf_escrow_yn" value="0" <?php echo get_checked($partner['cf_escrow_yn'], "0"); ?>>
			<label for="cf_inicis_escrow_yn2">사용안함</label>
		</td>
	</tr>
	<tr id='ids_ini_escrow'>
		<th>Escrow ID</th>
		<td><input type="text" name="cf_inicis_escrow_id" value="<?php echo $partner['cf_inicis_escrow_id']; ?>"
...
<div class="tbl_frm01">
	...
	<tbody>
	<tr>
		<th>무통장입금계좌<br>(쇼핑몰하단 노출)</th>
		<td>
			<input type='text' name="de_bank_name" itemname='은행명' placeholder="은행명" value="<?php echo $partner['de_bank_name']; ?>" class='frm_input' size="15">
			<input type='text' name="de_bank_account" itemname='계좌번호' placeholder="계좌번호" value="<?php echo $partner['de_bank_account']; ?>" class='frm_input' size="30">
			<input type='text' name="de_bank_holder" itemname='예금주명' placeholder="예금주명" value="<?php echo $partner['de_bank_holder']; ?>" class='frm_input' size="15">
		</td>
	</tr>
	<tr>
		<th>무통장입금계좌<br>(주문서에서 사용)</th>
		<td>
			<textarea name="cf_bank_account" class="frm_textbox wfull" rows="5"><?php echo $partner['cf_bank_account']; ?></textarea>
	...
	<tr>
		<th>인터넷뱅킹주소</th>
		<td>
			<textarea name="cf_banking"class="frm_textbox wfull" rows="5"><?php echo $partner['cf_banking']; ?></textarea>
...
function fregform_submit(f) {
	f.action = "./partner_pg_update.php";
    return true;
}
...
chk_pay_method('<?php echo $partner[cf_card_pg]; ?>');
</script>
