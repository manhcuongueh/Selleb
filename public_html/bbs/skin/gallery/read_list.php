...
<div class="page_wrap">
	...
	<?php echo pageing($page, $total_page, $total_count, "list.php?$qstr3&page="); ?>
...
<?php } else if($boardconfig['read_list']=='2') { ?>
<div class="tbl_frm01 mart30">
	<table class="wfull">
	<?php
	$sql = "select * from shop_board_{$boardid} where wdate > '{$boardinfo['wdate']}' {$sql_search2}";
	if($key && $keyword)
	...
	if(sql_num_rows($res)) {
		...
		$pre_no = $row['index_no'];
		$pre_subject = $row['subject'];
		$pre_tailcount = $row['tailcount'];
	?>
	<tr>
		<th width='15%'>▲ 이전 글</th>
		<td width='85%'><a href="read.php?index_no=<?php echo $pre_no; ?>&page=<?php echo $page; ?>&key=<?php echo $key; ?>&keyword=<?php echo $keyword; ?>&boardid=<?php echo $boardid; ?>"><?php echo $pre_subject; ?> [<?php echo $pre_tailcount; ?>]</a></td>
	</tr>
	<?php
	}
	...
	<tr>
		<th width='15%'>▼ 다음 글</th>
		<td width='85%'><a href="read.php?index_no=<?php echo $next_no; ?>&page=<?php echo $page; ?>&key=<?php echo $key; ?>&keyword=<?php echo $keyword; ?>&boardid=<?php echo $boardid; ?>"><?php echo $next_subject; ?> [<?php echo $next_tailcount; ?>]</a></td>
	</tr>
	<?php } ?>
	</table>
</div>
