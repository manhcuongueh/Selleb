...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<?php
			if($member['id']) {
				echo $boardinfo['writer_s'];
				echo "<input type='hidden' name='writer_s' value='$boardinfo[writer_s]'>";
			} else {
				echo "<input type='text' name='writer_s' value='$boardinfo[writer_s]' class='ed'>";
			}
			?>
		</td>
	</tr>
	...
	<tr>
		<th>제 목</th>
		<td><input type='text' name='subject' value="<?php echo $boardinfo['subject']; ?>" class="ed wfull"></td>
	</tr>
	<tr>
		<td colspan="2">
	...
	<tr>
		...
		<td>
			...
			<?php if($boardinfo['fileurl1']) { ?>
			<a href="<?php echo TW_DATA_PATH.'/board/'.$boardid.'/'.$boardinfo['fileurl1']; ?>" target="_blank"><span class="bold fc_255"><?php echo $boardinfo['fileurl1']; ?></span></a>
			<input type='checkbox' name='del_file1' value="<?php echo $boardinfo['fileurl1']; ?>"> 삭제
			<?php } ?>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<?php if($boardinfo['fileurl2']) { ?>
			<a href="<?php echo TW_DATA_PATH.'/board/'.$boardid.'/'.$boardinfo['fileurl2']; ?>" target="_blank"><span class="bold fc_255"><?php echo $boardinfo['fileurl2']; ?></span></a>
			<input type='checkbox' name='del_file2' value="<?php echo $boardinfo['fileurl2']; ?>"> 삭제
			<?php } ?></td>
	</tr>
	<?php } ?>
	</table>
