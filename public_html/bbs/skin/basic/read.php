...
<div class="tbl_frm01">
	...
	<?php if($bo_file1) { ?>
	<tr>
		<td colspan="2">첨부파일1 : <a href="download.php?file=<?php echo $bo_file1; ?>&url=<?php echo TW_DATA_PATH; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file1; ?>"><b><?php echo $bo_file1; ?></b></a></td>
	</tr>
	<?php } ?>
	<?php if($bo_file2) { ?>
	<tr>
		<td colspan="2">첨부파일2 : <a href="download.php?file=<?php echo $bo_file2; ?>&url=<?php echo TW_DATA_PATH; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file2; ?>"><b><?php echo $bo_file2; ?></b></a></td>
	</tr>
	<?php } ?>
	<tr>
		...
		if($bo_file1 && preg_match("/\.(gif|jpg|jpeg|png)$/i", $bo_file1))
		{
			...
			{
				$imgsize1 = getimagesize(TW_DATA_PATH."/board/".$boardid."/".$bo_file1);
		...
		?>
		<a href="javascript:imgview('<?php echo TW_DATA_PATH; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file1; ?>');"><img src="<?php echo TW_DATA_PATH; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file1; ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>"></a><br><br>
		<?php
		}
