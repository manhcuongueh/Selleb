...
if($_POST['mode'] == 'w') {
	...
	if($email) {
		...
		ob_start();
		include_once(TW_BBS_PATH.'/write_update_mail.php');
	...
	alert("정상적으로 접수 되었습니다. 빠른 시간안에 답변드리겠습니다", TW_BBS_URL."/qna_list.php");
}

$gw_head_title = '1:1 상담문의';
include_once("./_head.php");

$token = md5(uniqid(rand(), true));
set_session("ss_token", $token);

$form_action_url = TW_BBS_URL.'/qna_write.php';

include_once($theme_path.'/qna_write.skin.php');
