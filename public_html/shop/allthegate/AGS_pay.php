...
function Pay(form){
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// MakePayMessage() 가 호출되면 올더게이트 결제창이 화면에 나타나며 완료 시 Hidden 필드
	// 에 리턴값들이 채워지게 됩니다.
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(form.Flag.value == "enable"){
		...
		if(Check_Common(form) == true){
			...
			if(document.AGSPay == null || document.AGSPay.object == null){
				...
				//////////////////////////////////////////////////////////////////////////////////////////////////////////////
				// 올더게이트 결제창 호출 시 필요정보를 동적으로 적용하기위해 JavaScript 코드를 사용하고 있습니다.
	...
	<tr>
		...
		<table width=650 border=0 cellpadding=0 cellspacing=0>
			...
			<tr>
				...
				2) 지불요청을 위해 필요한 정보를 모두 입력후 '지불요청'버튼을 클릭하시면 올더게이트 웹표준 결제창을 실행합니다.<br>
				3) 신용카드만 사용시 꼭 <font color=#006C6C>결제지불방법</font>을 <font color=#006C6C><b>신용카드(전용)</b></font>으로 설정해 주십시오.<br>
				4) DB 작업을 하실 경우 <font color=#006C6C>결제성공여부(rSuccYn)</font>을 확인후에 작업하여 주십시오.<br>
				5) 핸드폰 결제 사용시 올더게이트에서 발급받은[핸드폰결제아이디,비밀번호,상품코드,상품타입]을 입력하여 주십시오.<br>
				6) 데이터 입력시 <font color=#006C6C>"|"</font>는 올더게이트에서 구분자로 사용하는 문자이므로 입력하지 말아 주십시오.
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
