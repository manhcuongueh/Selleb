...
include_once("./cfg/site_conf_inc.php"); // 환경설정 파일 include
require_once("./pp_ax_hub_lib.php"); // library [수정불가]
...
/* = ========================================================================== = */
			...
			alert($msg, TW_SHOP_URL."/orderinquiryview.php?odrkey=$ordr_idxx"); 		
		}
	}
}
	// End of [res_cd = "0000"]
