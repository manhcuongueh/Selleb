...
for($i=0; $row=sql_fetch_array($result); $i++)
{
	...
	echo "\n{$row['index_no']}{$tab}{$row['gname']}{$tab}{$row['account']}{$tab}{$item_link}{$tab}{$img_url}{$tab}{$cate1}{$tab}{$cate2}{$tab}{$cate3}{$tab}{$row['model']}{$tab}{$row['brand_nm']}{$tab}{$row['maker']}{$tab}{$row['origin']}{$tab}{$row['gpoint']}{$tab}{$delivery}";
}
