...
$cb_encode_path = $_SERVER['DOCUMENT_ROOT']."/plugin/chekplus/CPClient"; // NICE로부터 받은 암호화 프로그램의 위치
...
$returnurl	= "http://".$_SERVER['HTTP_HOST']."/plugin/chekplus/checkplus_success.php";	// 성공시 이동될 URL
$errorurl	= "http://".$_SERVER['HTTP_HOST']."/plugin/chekplus/checkplus_fail.php"; // 실패시 이동될 URL
