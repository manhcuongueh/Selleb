...
$sModulePath	= $_SERVER['DOCUMENT_ROOT']."/plugin/chekplus/IPIN2Client"; // NICE로부터 받은 암호화 프로그램의 위치
$sReturnURL		= "http://".$_SERVER['HTTP_HOST']."/plugin/chekplus/ipin_process.php"; // 하단내용 참조
$sCPRequest		= ""; // 하단내용 참조
