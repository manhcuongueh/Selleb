...
if (!is_writeable("..")) {
	header("Content-Type: text/html; charset=utf-8");
	die("루트 디렉토리의 퍼미션을 707로 변경하여 주십시오.");
}
?>
<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8">
<title>솔루션 설치 (1/3) - 라이센스(License)</title>
<style type="text/css">
<!--
.body {
    font-family: 굴림;
	...
	<div class="fg">
		...
		<tr> 
			...
			<td width="581" valign="top" bgcolor="#FCFCFC">
				...
				<tr> 
					<td align="center"><textarea name="textarea" style='width:99%' rows="9" class="box" readonly><?=implode("", file("../LICENSE.txt"));?></textarea></td>
				</tr>
				<tr>
					<td height=10></td>
				</tr>
