...
<!-- 퀵메뉴 좌측날개 시작 { -->
<div id="qcl">
	<?php echo banner_repeat(90, 0, 0, $pt_id); ?>
</div>
<!-- } 퀵메뉴 좌측날개 끝 -->
	...
	<ul>
		...
		<li>
			...
			foreach($pr_idx as $idx)
			{
				...
				$href = TW_SHOP_URL.'/view.php?index_no='.$idx;
		...
		<li class="pg_wrap">
			<img src="<?php echo TW_IMG_URL; ?>/bt_qcr_prev.gif" id="up">
			<span id="stv_pg"></span>
			<img src="<?php echo TW_IMG_URL; ?>/bt_qcr_next.gif" id="down">
		</li>
		<?php } ?>
	</ul>
</div>
...
$(function() {
	...
	$(window).scroll(function () {
		if($(this).scrollTop() > Theight) {
			$("#qcr, #qcl").css({'position':'fixed','top':'67px','z-index':'9999'});
		} else {
