...
<p class="tit_navi marb10"><a href='<?php echo TW_URL; ?>'>홈</a> <i class="ionicons ion-ios-arrow-right"></i> 기획전 <i class="ionicons ion-ios-arrow-right"></i> <?php echo $gw_head_title; ?></p>
<?php if($bimg_url) { ?>
<div class="marb10"><img src="<?php echo $bimg_url; ?>" width="1000"></div>
<?php } ?>
<div class="tab_sort">
