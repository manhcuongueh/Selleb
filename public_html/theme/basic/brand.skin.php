...
<div class="br_search">
	...
	<dl class="sch_inner">
		...
		<dd><input type="text" name="qstx" value="<?php echo $qstx; ?>" id="ssch_q" placeholder="브랜드명을 입력해주세요." maxlength="30"><button type="submit" class="btn_submit fa fa-search"></button></dd>
	</dl>
	<div id="br_sch">
		<ul class="sch_tab">
