...
$qstr1 = 'cate='.$cate.'&page_rows='.$page_rows.'&sort='.$sort.'&sortodr='.$sortodr;
$qstr2 = 'cate='.$cate.'&page_rows='.$page_rows;
$qstr3 = 'cate='.$cate.'&sort='.$sort.'&sortodr='.$sortodr;
...
?>
<p class="tit_navi"><a href='<?php echo TW_URL; ?>'>홈</a><?php echo get_move($cate); ?></p>
<h2 class="stit"><?php echo get_catename($cate); ?></h2>

<?php
$cgy = get_category_head_image($cate);
echo $cgy['img_head']; // 분류별 상단이미지

echo tree_category($cate); // 하위분류
?>
